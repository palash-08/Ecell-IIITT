    ...
    <div className="max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        <div className="flex gap-3">
          <button onClick={fetchTeam} className="p-3 bg-white border border-gray-200 rounded-xl text-gray-600 hover:text-black shadow-sm">
            <FiRefreshCcw size={20} />
          </button>
          <Link href="/admin/team/add" className="flex items-center gap-2 bg-[#FFB800] text-black px-6 py-3 rounded-xl font-bold hover:bg-[#e6a700] transition-all shadow-sm">
            <FiPlus size={20} />
            Add Member
          </Link>
        </div>
