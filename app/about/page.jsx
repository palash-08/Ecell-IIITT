            ...
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-4xl md:text-5xl font-extrabold text-black tracking-tight">
                  A Message from Our{" "}
                  <span className="text-[#FFB800]">Faculty Advisor</span>
                </h2>
              </div>
              ...
              {faculty.map((f, index) => (
                <div
                  key={f._id}
                  className={`flex flex-col md:flex-row items-center gap-12 bg-[#F5F5F5] p-10 md:p-12 rounded-[2.5rem] shadow-sm border border-gray-200 ${index > 0 ? "mt-12" : ""}`}
                >
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-t border-gray-100 pt-8">
                        <div>
                          ...
                          <p className="text-[#FFB800] font-black text-sm uppercase tracking-widest">
                            {f.role}
                          </p>
                        </div>
